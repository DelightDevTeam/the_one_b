...
const Footer = () => {
  ...
  return (
    <footer className='pt-5 pb-4 px-2 px-md-5 mb-5 mb-lg-0'>
      <div className=' '>
        <h2 className='mb-4 footerTitle'>The One Slot</h2>
        <p>
          မြန်မာနိုင်ငံတွင် အလျော်စားမှန်ကန်ဆုံးနှင့် maxwin အပေါက်အများဆုံး
          Slot ဆိုဒ်ကြီး...အလျော်စားမှန်ကန်မှုမရှိပါက customer service သို viber
          သိုမဟုတ် telegram မှ တိုင်ကြားနိုင်ပါသည်
        </p>
